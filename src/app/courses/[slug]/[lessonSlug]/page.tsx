      ...
      <div className="lesson-layout">
        <aside className="lesson-sidebar">
          ...
          {course.modules.map((courseModule) => (
            <div key={courseModule.id} className="sidebar-module">
        ...
        <article className="lesson-content">
          ...
          {hasPublishedQuiz && (
            <section className="resource-box">
              <ListChecks />
              <div>
                <strong>{lesson.quiz?.title || 'Lesson quiz'}</strong>
                <p>
                  Pass this quiz to complete the lesson. Required score:{' '}
          ...
          <nav className="lesson-nav">
            ...
            {next ? (
              ...
              <Link className="primary" href={`/courses/${course.slug}`}>
                Course overview
                <ArrowRight />
              </Link>
            )}
